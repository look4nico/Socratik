    ...
    <body>
        <?php
                if (security_loggedIn()) {
                    echo("<h1 id='introD'>Account already present</h1><br>");
                    ...
                    "<html>
                        ...
                        <body>
                            <h1 id='introD'>NEW ACCOUNT SIGNUP</h1>
                            <h2 class='introBody'>Please enter account info</h2>
                            <form action='signup.php' method='POST'>
                                <label class='introBody' for='username'>Username</label><br>
                                <input class='postInput' type='text' id='username' name='username'><br>
                                <label class='introBody' for='password'>Password</label><br>                    
                                <input class='postInput' type='password' id='password' name='password'><br><br>
                                <input class='postInput' type='submit' name='submit' value='Sign up'>
                            </form>
